/*! elementor - v3.6.7 - 03-07-2022 */"use strict";(self["webpackChunkelementor"]=self["webpackChunkelementor"]||[]).push([["text-path"],{"../modules/shapes/assets/js/frontend/handlers/text-path.js":
/*!******************************************************************!*\
...
setText(newText){const{url,is_external:isExternal,nofollow}=this.getElementSettings()?.link;const target=isExternal?'_blank':'',rel=nofollow?'nofollow':'';if(url){newText=`<a href="${(0, _utils.escapeHTML)(url)}" rel="${rel}" target="${target}">${(0, _utils.escapeHTML)(newText)}</a>`;}
